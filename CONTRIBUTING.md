Contributing to IPC Core
============================

The IPC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IPC Core project, and is not to be
confused with overall IPC Network Protocol consensus changes.

Whether a pull request is merged into IPC Core rests with the project merge
...
Patches that change IPC consensus rules are considerably more involved than
...
Where a patch set proposes to change the IPC consensus, it must have been
...
The project leader is the release manager for each IPC Core release.
