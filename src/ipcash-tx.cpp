...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ipcash Core ipcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ipcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ipcash transaction") + "\n" +
                               "  ipcash-tx [options] -create [commands]   " + _("Create hex-encoded ipcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ipcash transaction
