...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeIpcashAmount"))
        settings.setValue("nAnonymizeIpcashAmount", 1000);

    nObfuscationRounds = settings.value("nObfuscationRounds").toLongLong();
    nAnonymizeIpcashAmount = settings.value("nAnonymizeIpcashAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeIpcashAmount"))
        SoftSetArg("-anonymizeipcashamount", settings.value("nAnonymizeIpcashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ipcash.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeIpcashAmount:
            return QVariant(nAnonymizeIpcashAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case ObfuscationRounds:
            ...
            break;
        case AnonymizeIpcashAmount:
            nAnonymizeIpcashAmount = value.toInt();
            settings.setValue("nAnonymizeIpcashAmount", nAnonymizeIpcashAmount);
            emit anonymizeIpcashAmountChanged(nAnonymizeIpcashAmount);
            break;
        case CoinControlFeatures:
