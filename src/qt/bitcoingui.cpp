                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IPC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IPC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ipcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IPC Core"), this);
    aboutAction->setStatusTip(tr("Show information about IPC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IPC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IPC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IPC addresses"));
    ...
    openAction->setStatusTip(tr("Open a IPC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IPC Core help message to get a list with possible IPC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IPC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IPC network", "", count));
}
...
{
    QString strTitle = tr("IPC Core"); // default title
