...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ipcash features */
        {"ipcash", "masternode", &masternode, true, true, false},
        {"ipcash", "masternodelist", &masternodelist, true, true, false},
        {"ipcash", "mnbudget", &mnbudget, true, true, false},
        {"ipcash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ipcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ipcash", "mnsync", &mnsync, true, true, false},
        {"ipcash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ipcash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ipcashd, or the -server option to ipcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ipcash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55993/\n";
}
