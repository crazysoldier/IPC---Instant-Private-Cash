...
In order to support loading of multiple wallets in ipcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ipcash.cpp.
...
Changes to ipcash.cpp
----------------------
ipcash.cpp is the entry point into ipcash-qt, and as such, will require some minor modifications to provide hooks for
