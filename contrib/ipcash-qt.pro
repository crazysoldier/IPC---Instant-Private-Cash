...
RESOURCES += src/qt/ipcash.qrc src/qt/ipcash_locale.qrc

TRANSLATIONS += src/qt/locale/ipcash_bg.ts \
                src/qt/locale/ipcash_de.ts \
                src/qt/locale/ipcash_en.ts \
                src/qt/locale/ipcash_es.ts \
                src/qt/locale/ipcash_fi.ts \
                src/qt/locale/ipcash_fr.ts \
                src/qt/locale/ipcash_it.ts \
                src/qt/locale/ipcash_ja.ts \
                src/qt/locale/ipcash_pl.ts \
                src/qt/locale/ipcash_pt.ts \
                src/qt/locale/ipcash_ru.ts \
                src/qt/locale/ipcash_sk.ts \
                src/qt/locale/ipcash_sv.ts \
                src/qt/locale/ipcash_vi.ts \
                src/qt/locale/ipcash_zh_CN.ts \
                src/qt/locale/ipcash_zh_TW.ts
